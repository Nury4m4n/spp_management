        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center" width="25%">
              ...
              <a href="spp-edit.php?id_spp=<?= $data['id_spp'];?>" class="badge badge-primary p-2" title="Edit"><i
                  class="fas fa-edit"></i></a> | <a href="spp-delete.php?id_spp=<?= $data['id_spp'];?>"
      ...
      <div class="modal-body">
        <form action="spp-simpan.php" method="post">
          <div class="input-group mb-1">
            ...
            <input type="text" name="tahun_ajaran" required autocomplete="off" class="form-control form-control-sm"
              placeholder="Input Tahun Ajaran">
          </div>
          <div class="input-group mb-1">
            <span class="input-group-text lebar">Bulanan</span>
            <input type="text" name="nominal" class="form-control form-control-sm text-right angkaSemua money"
              placeholder="Input SPP Bulanan" required autocomplete="off">
          </div>
