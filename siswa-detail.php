        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center" width="13%">
              ...
              <a href="siswa-detail-delete.php?id_detail_siswa=<?= $data['id_detail_siswa'];?>"
            ...
            <div class="input-group mb-1">
              ...
              <select name="id_kelas" class="form-control form-control-chosen" required>
                ...
                <?php
							...
							$query = mysqli_query($koneksi, $sql);
							while($d = mysqli_fetch_array($query)){?>
                <option value="<?= $d['id_kelas'];?>"><?= $d['kelas']; ?>-<?= $d['nama_kelas']; ?> -
            ...
            <div class="input-group mb-1">
              ...
              <select name="id_spp" class="form-control form-control-chosen" required>
                ...
                <?php
							...
							$query = mysqli_query($koneksi, $sql);
							while($d = mysqli_fetch_array($query)){?>
                <option value="<?= $d['id_spp'];?>">Rp. <?= number_format($d['nominal']); ?> - Tahun Ajaran:
