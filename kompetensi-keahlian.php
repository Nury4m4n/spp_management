        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center" width="25%">
              ...
              <a href="kompetensi-keahlian-edit.php?id_kompetensi=<?= $id_kompetensi;?>" class="badge badge-primary p-2"
                title="Edit"><i class="fas fa-edit"></i></a> | <a
                href="kompetensi-keahlian-delete.php?id_kompetensi=<?= $id_kompetensi;?>"
      ...
      <div class="modal-body">
        <form action="kompetensi-keahlian-simpan.php" method="post">
          ...
          <div class="input-group mb-1">
            ...
            <input type="text" name="nama_kompetensi_keahlian" required autocomplete="off"
              class="form-control form-control-sm" placeholder="Input Nama Kompetensi Keahlian">
          </div>
