...
<body>
	...
	<div class="kotak">
		<form class="form-signin" action="proses.php" method="post">
			<img src="img/logo.PNG" alt="SPP Login" width="50px" height="50px" style="margin-left:25px;">

			<div style="margin-left:100px;margin-top:-35px;font-size:22px; margin-bottom:15px;">Aplikasi SPP</div>
