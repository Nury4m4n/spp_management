...
<body onload="window.print(); window.onafterprint = window.close; ">
  ...
  <span style="font-size: 24px;">REKAPITULASI TRANSAKSI PERIODE
    <?= date_format(date_create($periodeDari),"d M Y") ." s/d tanggal " . date_format(date_create($periodeSampai), "d M Y"); ?>
  </span>
  <?php 
      if($nisn!=""){
