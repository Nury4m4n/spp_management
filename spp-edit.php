    ...
    <div class="col-6">
      ...
      <form action="spp-update.php" method="post">
        ...
        <div class="input-group mb-1 input-sm">
          ...
          <input type="text" name="tahun_ajaran_baru" class="form-control form-control-sm" required autofocus
            autocomplete="off" value="<?= $data['tahun_ajaran'];?>">
        </div>

        <!-- Nominal -->
        <div class="input-group mb-1 input-sm">
          <span class="input-group-text lebar">Nominal</span>
          <input name="nominal" class="form-control form-control-sm text-right money angkaSemua" required
            value="<?= $data['nominal'];?>">
        </div>
        ...
        <div class="input-group mb-1 input-sm">
          <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-save"></i> Update </button>| <a
            href="spp.php" class="btn btn-sm btn-warning"><i class="fas fa-redo"></i> Cancel</a>
        </div>
      </form>
    </div>
  </div>
