...
<div class="container-fluid pt-3 pb-5">
  <div class="row">
    <div class="col-xl-12">
      <h3 class="text-center text-uppercase text-dark">Data Transaksi</h3>
      <hr class="hr">
    </div>
  </div>
    ...
    <div class="row mb-4 mt-2">
      <div class="col-xl-11">
        <div class="input-group mb-1">
          ...
          <input type="date" name="periodeDari" id="periodeDari" class="form-control form-control-sm"
            value="<?= $tglHariIni; ?>">

          <span class="input-group-text lebar1">Sampai</span>
          <input type="date" name="periodeSampai" id="periodeSampai" class="form-control form-control-sm"
            value="<?= $tglHariIni; ?>">
          ...
          <select name="nisn" class="form-control form-control-sm form-control-chosen">
            ...
            <option value="<?= $k['nisn']; ?>"><?= $k['nama_siswa']; ?> - <?= $k['kelas']; ?>-<?= $k['nama_kelas']; ?> -
              <?= $k['nama_kompetensi_keahlian']; ?></option>
            <?php 
              }
            }else{
          ...
          <button class="btn btn-sm btn-success text-white" type="submit" id="periodePrint" name="cetak"><i
