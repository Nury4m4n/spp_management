      ...
      <div class="col">
        <form action="pembayaran-update.php" method="post">
          ...
          <div class="input-group mb-1">
            ...
            <input type="date" name="tgl_bayar" required autocomplete="off" class="form-control"
          ...
          <div class="input-group mb-1">
            ...
            <select name="id_spp" class="form-control" required>
              ...
              <option value="<?= $d['id_spp'];?>" <?php if($data['id_spp']==$id_spp){echo 'selected="selected"';}?>>
                <?= $d['tahun'];?></option>
              <?php
							}?>
            </select>
          ...
          <div class="input-group mb-1">
            <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-save"></i> Update </button>| <a
              href="pembayaran.php" class="btn btn-sm btn-warning"><i class="fas fa-redo"></i> Cancel</a>
          </div>
        </form>
      </div>
    </div>
