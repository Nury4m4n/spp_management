  ...
  <div class="row my-2 ">
    <div class="col-10">
      <div class="jumbotron p-3 m-0">
        ...
        <hr>
        <p class="jumbotron-footter">SMK NURADEMY <?= date('Y'); ?></p>
      </div>
    </div>
  </div>
  <?php
  ...
  <div class="row pt-3">
    ...
    <div class="col-3">
      <div class="card shadow-lg mb-3">
        <div class="card-header bg-info border-success judul-spp">SISWA <span
            class="badge badge-primary text-right"><?= $laki_laki + $perempuan; ?></span></div>
