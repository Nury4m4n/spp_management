    ...
    <div class="col-6">
      ...
      <form action="petugas-update.php" method="post">
        ...
        <div class="input-group mb-1 input-sm">
          ...
          <input type="text" name="nama_petugas" class="form-control form-control-sm" required autofocus
            autocomplete="off" value="<?= $data['nama_petugas'];?>">
        </div>
        ...
        <div class="input-group mb-1">
          ...
          <input type="text" name="username_baru" class="form-control form-control-sm" required autocomplete="off"
            value="<?= $data['username'];?>">
        </div>
        ...
        <div class="input-group mb-1">
          <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-save"></i> Update</button> | <a
            href="petugas.php" class="btn btn-sm btn-warning"><i class="fas fa-redo"></i> Cancel</a>
        </div>
      </form>
    </div>
  </div>
